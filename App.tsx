...
import { AbiItem, toTxResult } from "@celo/connect";
...
export default class App extends React.Component {
  ...
  componentDidMount = async () => {
    ...
    const deployedNetwork = (contract as any).networks[networkId.toString()];
  ...
  getCount = async () => {
    ...
    let _count = await (this.state.CounterContract as any).methods
      .getCount()
      .call();
  ...
  increment = async () => {
    ...
    const txObject = await (
      this.state.CounterContract as any
      ...
      [
        {
          ...
          to: (this.state.CounterContract as any).options.address,
          tx: txObject,
    ...
    return (
      <View style={styles.container}>
        ...
        <View style={styles.buttonContainer}>
          <Button title="Increment count" onPress={() => this.increment()} />
          <Button title="Decrement count" onPress={() => this.decrement()} />
        </View>
      </View>
    );
  }
